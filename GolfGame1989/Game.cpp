...
void Game::DrawTree2(const DirectX::SimpleMath::Vector3 aTreePos)
{
    ...
    DirectX::SimpleMath::Vector3 swayVec = windNormalized * scale * cosf(static_cast<float>(m_timer.GetTotalSeconds()));
