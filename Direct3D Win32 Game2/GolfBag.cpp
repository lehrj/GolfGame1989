...
void GolfBag::BuildBag()
{
    ...
    */
    ...
    m_bag[i].balancePoint = 0.75;
    m_bag[i].coefficiantOfRestitution = 0.78;
    m_bag[i].length = 1.16205;
    m_bag[i].mass = 0.330;
    m_bag[i].massMoI = 0.08;
    m_bag[i].firstMoment = m_bag[i].mass * m_bag[i].length * m_bag[i].balancePoint; // First moment of the rod representing the club about the wrist axis (where the club rod connects to the arm rod) in kg m 
    ++i;
